...
- **Data Strategy** — a pipeline architecture diagram, the real-vs-illustrative badge-discipline
  ...
  **Live Integrity Gate** — 10 reconciliation checks that run in your browser on every page load,
...
2. **`node stress.cjs`** — a distinct adversarial sweep, not a renamed copy of verify.cjs: no
   ...
   markup, and (added with the 20-KPI catalog) that all 19 formula/methodology explainer divs
